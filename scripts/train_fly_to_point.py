...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train Q250 Fly-to-Point with RSL-RL PPO")
...
def main() -> None:
    ...
    print("observation       : target_b + lin_vel_b + gravity_b + ang_vel_b (12D)\n")
